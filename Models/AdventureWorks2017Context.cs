    ...
    public partial class AdventureWorks2017Context : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("Server=tcp:mysqlserver7476.database.windows.net,1433;Initial Catalog=mySQLDB7476;Persist Security Info=False;User ID=rajesh.prasad0;Password=Happy@200789;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
            }
        }
